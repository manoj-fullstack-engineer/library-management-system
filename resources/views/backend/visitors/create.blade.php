...
<div class="container-fluid">
    ...
    <form action="{{ route('backend.visitors.store') }}" method="POST" autocomplete="off">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" id="visited_at" name="visited_at" class="form-control datepicker" value="{{ old('visited_at', now()->format('d/m/Y')) }}">
        </div>
